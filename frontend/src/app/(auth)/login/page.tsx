...
export default function LoginPage() {
  ...
  async function onSubmit(data: Form) {
    ...
    try {
      ...
      const user = await auth.me()  // dohvati user podatke sa novim tokenom
      // Privremeno setuj token da bi me() poziv radilo
    ...
    <div className="flex min-h-screen items-center justify-center bg-gray-50 px-4">
      <div className="w-full max-w-sm">
        ...
        <div className="mb-8 text-center">
          ...
          <h1 className="text-xl font-bold text-gray-900">AI Finansijska Analiza</h1>
          <p className="mt-1 text-sm text-gray-500">Prijavite se na vaš nalog</p>
        </div>
